...
* (1);
Prop_eff_test(i) = ((CT_test(i)/CP_test(i))*J1(i));
c =.5
end
%% Plots
o = linspace(0,140,100)
t = linspace(0.6,.9,100)
u = linspace(.9386,.9386,100)
e = linspace(1.045,1.045,100)
figure(1)
yyaxis left
plot(J1,P_produced_test,'b','LineWidth',2,'LineStyle',':')
hold off
title('Power')
...
hold off
figure(2)
plot(J1,CP_test,'k','LineWidth',2,'LineStyle',':')
...
figure(1)
yyaxis right
plot(J1,T_produced_test,'r','LineWidth',2,'LineStyle',':')
title('Thrust Produced [lb] and Power Produced [lb]')
xlabel('Advanced Ratio J [1/rev]')
ylabel('Thrust Produced [lb]')
hold off
figure(2)
yyaxis right
plot(J1,CT_test,'b','LineWidth',2,'LineStyle',':')
title('Coefficient of Thrust and Power')
xlabel('Advanced Ratio J [1/rev]')
ylabel('Coefficient of Thrust')
hold off
figure(3)
plot(J1,Prop_eff_test,'b','LineWidth',2,'LineStyle',':')
